...
const LinkSectionSearchResult_1 = __importDefault(require("./LinkSectionSearchResult"));
class LinkSectionEditor extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Wrapper, null,
            ...
            React.createElement(SearchResults, { id: "link-search-results" }, results.map((result, index) => (React.createElement(LinkSectionSearchResult_1.default, { key: result.id, title: result.name, subtitle: result.subtitle, children: result.children, icon: React.createElement(outline_icons_1.DocumentIcon, { color: theme.toolbarItem }), onMouseOver: () => this.handleFocusLink(index), onClick: this.handleSelectSection(result), selected: index === selectedIndex }))))));
    }
}
...
//# sourceMappingURL=LinkSectionEditor.js.map